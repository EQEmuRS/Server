...
namespace Titanium {
	...
	namespace consts {
		static const size_t CHARACTER_CREATION_LIMIT = 8; // Hard-coded client value - DO NOT ALTER
		...
		static const uint32 BANDOLIERS_SIZE = 4;		// size = number of bandolier instances
