...
#undef PutFieldN
	...
	ENCODE(OP_SendCharInfo)
	{
		...
		// Special Underfoot adjustment - client uses a base of 8 clients and adjusts with this property
		uint32 adjusted_chars = eq->total_chars - 8; // Yes, it wraps around for < 8 -U
		eq->total_chars = adjusted_chars;		
